// inject_output3.js
// Reads all JSON files from site/_work/output3/ and replaces each entry
// in the corresponding catalog HTML file with the rewritten HTML.
// Usage: node site/_work/inject_output3.js [--dry-run]

const fs   = require("fs");
const path = require("path");

const OUTPUT_DIR  = path.join(__dirname, "output3");
